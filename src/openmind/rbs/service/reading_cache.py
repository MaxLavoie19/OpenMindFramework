...
class ReadingCache:
    ...
    def values(self, rbs: RuleBasedGame, row: PositionRow, base: str, reading: str) -> tuple[float | None, ...]:
    ...
    def _read(self, rbs: RuleBasedGame, row: PositionRow, base: str, reading: str) -> tuple[float | None, ...]:
