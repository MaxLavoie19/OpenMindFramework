...
def create_domain(name: str) -> Domain:
    ...
    "prisonersdilemma", a variant such as "prisonersdilemma/uncertain", "rockpaperscissors", or a domain an installed project registers
    ...
    if name == ROCK_PAPER_SCISSORS:
        return create_rock_paper_scissors_domain()
