...
#: How an agent chose a move on a clock: its deduction fallback then the search, the search alone, or a random legal
#: move, for a player out of time.
FULL_OPTION, SEARCH_OPTION, RANDOM_OPTION = "fallback and search", "search", "random"
