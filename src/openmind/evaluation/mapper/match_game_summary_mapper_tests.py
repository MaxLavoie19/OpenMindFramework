...
from openmind.evaluation.service.match_runner_tests import first_mover_decides
...
def test_the_evaluated_model_sits_in_its_seat_and_a_match_s_steps_have_no_budget() -> None:
    game = MatchGame((0.0, 1.0), None, 1, None, (), 7, 8, (0.5,), (Clock(59.5), Clock(60.0)))

    summary = MatchGameSummaryMapper().to_summary(
        first_mover_decides(), game, "match", 2, 4, 1, EVALUATED, OPPONENT, None, TimeControl(60.0)
    )
