...
from openmind.evaluation.service.evaluator_tests import Declare, first_mover_decides
...
def test_a_choice_is_measured_against_the_action_values(declared: Declare) -> None:
    ...
    (measure,) = new_measurer().measure(rbs, builder, ((rbs.start(), values),), 0.0, "Agreement", 30)
...
def test_optimal_actions_are_the_best_or_within_the_tolerance_of_it(declared: Declare) -> None:
